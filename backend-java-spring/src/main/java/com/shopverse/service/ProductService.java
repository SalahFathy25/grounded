...
public class ProductService {
    ...
    public ProductDtos.PageResponse<ProductDtos.ProductDto> list(boolean activeOnly, Long categoryId, String keyword,
        ...
        List<Product> rows = productRepository.search(activeOnly, categoryId, pattern, minPrice, maxPrice, orderBy, size, page * size);
        long total = productRepository.countSearch(activeOnly, categoryId, pattern, minPrice, maxPrice);
